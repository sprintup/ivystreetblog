...
export default function WorksheetChecklist({
  ...
  const wordBuildingReviewPrompt = shouldAskToValidateWordBuilding
    ? 'Are these correct? Cross out any forms that do not sound right.'
    : '';
      ...
      <div className='word-garden-worksheet-layout grid gap-8 xl:grid-cols-[minmax(0,1.15fr)_minmax(320px,0.85fr)] pb-12 md:pb-16'>
        <div className='no-print space-y-8'>
          <article className='rounded-3xl bg-primary/50 border border-accent/20 p-6 shadow-lg'>
            <h2 className='text-2xl text-yellow mb-4'>How The Word Sounds</h2>
            <div className='grid gap-6 md:grid-cols-2'>
              ...
              <div>
                ...
                <p className='text-accent'>
                  Onset: <span className='text-yellow'>{wordDetail.onsetAndRime.onset || '-'}</span>
                </p>
                <p className='text-accent'>
                  Rime: <span className='text-yellow'>{wordDetail.onsetAndRime.rime || '-'}</span>
                </p>
              </div>
            </div>
            ...
            <div className='mt-8 grid gap-6 md:grid-cols-2'>
              ...
              <div>
                ...
                <div className='rounded-2xl bg-secondary/70 p-4 text-accent space-y-2'>
                  ...
                  <p>Look at the beginning: {wordDetail.onsetAndRime.onset || 'vowel start'}</p>
                  <p>Look at the rest: {wordDetail.onsetAndRime.rime || wordDetail.word}</p>
